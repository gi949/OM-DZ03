...
Создаем файл с правилами оповещения alert.rules, в котором создаем правило, которое будет срабатывать при недоступности exporter-ов
и правило, которое будет срабатывать при недоступности страниц CMS.
